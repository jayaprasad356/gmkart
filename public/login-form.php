            ...
            <form method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control" value="<?= defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0 ? 'superadmin' : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Password :</label>
                        <input type="password" class="form-control" name="password" value="<?= defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0 ? '12345678' : '' ?>" required>
                    </div>
